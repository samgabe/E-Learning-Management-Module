  ...
  <section id="container" >
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> View Courses details</h3>
            <h4><i class="fa fa-angle-right"></i> <a href="upload-courses.php">Upload course details</a></h4>
				<div class="row">
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i> Course Details </h4>
	                  	  	  <hr>
                              <thead>
                              <tr>
                                  <th>Cno.</th>
                                  <th class="hidden-phone">School Name</th>
                                  <th> Course ID</th>
                                  <th> Course Name</th>
                                  <th> Course Status</th>
                              ...
                              <tr>
                                  ...
                                  <td>
                                     <a href="view-courses.php?id=<?php echo $row['id'];?>"> 
